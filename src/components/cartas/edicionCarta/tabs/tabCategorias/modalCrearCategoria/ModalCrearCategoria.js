...
import { FormCrearCategoria } from '../formCrearCategoria/FormCrearCategoria';
...
export const ModalCrearCategoria = ({open, close}) => {
    if(!open) return null
    return (
        <>
            ...
            <div style={DIV_MODAL_STYLE} className='conte-modal'>
                ...
                {/* <EdicionRapidaCarta carta={data}/> */}
                <FormCrearCategoria close={close}/>
            </div>
        </>
    )
}
